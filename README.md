...
כלי reference לאנשי IT, DevOps וסטודנטים. 64 רשומות ב-4 מודולים:

- 🐧 **Linux** — 27 פקודות (רשת, תהליכים, דיסק, הרשאות, מערכת, לוגים, משתמשים)
- ⊞ **CMD / Windows** — 15 פקודות עם שקילויות לינוקס
- 🌐 **רשת** — 12 כלים cross-platform (nmap, dig, netcat, openssl, iperf3...)
- 🔧 **פתרון תקלות** — 10 תרחישים step-by-step (SSH, דיסק מלא, CPU גבוה...)
